...
public class TicketGetAllHandler extends TicketBaseHandler<TicketGetAllQuery, List<TicketDetailDto>> {
    ...
    public List<TicketDetailDto> execute() {
        ...
        return tickets.stream().map(ticketMapper::toDetailDto).toList();
    }
}