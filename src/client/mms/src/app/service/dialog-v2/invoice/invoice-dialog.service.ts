...
import { InvoiceDetailDialogDataModel, InvoiceDetailV2 } from '../../../feature/invoice-v2/detail/invoice-detail-v2';
...
export class InvoiceDialogService extends EntityDialogServiceV2<InvoiceModel> {
  ...
  override displayInfo(id: string, data?: InvoiceDetailDialogDataModel): Observable<any> {
    return super.displayInfo(id, data);
  }
